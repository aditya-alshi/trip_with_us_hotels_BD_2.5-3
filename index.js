...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = hotelsCopy.sort((hotel1, hotel2) => {
    ...
    else if(pricing === "high-to-low") return hotel2.price - hotel1.price;
  })
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let result = hotelsCopy.sort((hotel1, hotel2) => {
    ...
    else if(rating === "high-to-low") return hotel2.rating - hotel1.rating;
  })
  res.json({ hotels: result });
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let result = hotelsCopy.sort((hotel1, hotel2) => {
    ...
    else if(reviews === "most-to-least") return hotel2.reviews - hotel1.reviews;
  })
  res.json({ hotels: result });
});

// Function that returns the hotels of the selected amenity
...
// Function that returns the hotels if it meets the selected country criteria
...
// Function that returns the hotels if it meets the selected category criteria
